...
const Contact = () => {
  return (
    <div className="bg-slate-100 w-[95vw] mx-auto">
      ...
      <div className="flex w-[85vw] m-auto justify-betwwen gap-6 py-12 flex-wrap-reverse md:w-[95vw]  xl:w-[85vw] justify-center xl:justify-normal">
        <div className="bg-white w-full rounded-lg shadow-md px-5 py-6 flex flex-col gap-10 md:w-[40vw] xl:w-[35vw] ">
          ...
          <div className=" flex flex-col gap-3">
            ...
            <p className="text-sm font-normal text-slate-950">+129290122122</p>
          </div>
          <div className="flex flex-col gap-3">
            <h3 className="text-lg font-medium	text-slate-950">Email Address</h3>
            <p className="text-sm font-normal text-slate-950">demo@demo.com</p>
          </div>
          <div className=" flex flex-col gap-3">
