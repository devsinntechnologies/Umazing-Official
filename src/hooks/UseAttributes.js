...
export const attribute = createApi({
  ...
  baseQuery: fetchBaseQuery({ baseUrl: `${BASE_URL}/attribute/` }),
  endpoints: (builder) => ({
...
export const { useGetAllAttributesQuery, useAddAttributeMutation, useGetAllAttributeValuesQuery, useAddAttributeValueMutation } = attribute;
