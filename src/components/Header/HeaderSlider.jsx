...
import { ChevronLeft, ChevronRight } from "lucide-react"; // Lucide icons for custom navigation
    ...
    <div className="relative w-full h-full">
      ...
      >
        {offers.data.map((offer) => (
          <SwiperSlide
            key={offer.id}
            className="relative flex items-center justify-between bg-primary p-10 lg:p-20 w-full h-full"
          >
            {/* Text Content */}
            <div className="max-w-lg pt-3 md:pt-0 spce-y-4 text-white flex-1 h-full">
      ...
      <button
        ...
        className="absolute top-1/2 left-4 z-10 transform -translate-y-1/2 bg-black bg-opacity-50 text-white p-3 rounded-full hover:bg-opacity-80 transition"
      >
      ...
      <button
        ...
        className="absolute top-1/2 right-4 z-10 transform -translate-y-1/2 bg-black bg-opacity-50 text-white p-3 rounded-full hover:bg-opacity-80 transition"
      >
